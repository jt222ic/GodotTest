...
# Vector poiints for start,endpoint and path in an array
var _start_point = Vector2i(10,10)
var _end_point = Vector2i(12,10)
...
func _ready():
    ...
    _astar.update()
    find_path(_start_point, _end_point)
...
#func _draw():   ## Must use as inherit engine to draw out stuffs also
